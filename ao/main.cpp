...
void ao::m_set_query(float new_t){
...
void ao::m_toggle_regions(int active){
...
void ao::m_set_region(int start, int end){
...
float ao::_get_distance(vector<float> event1, vector<float> event2){
...
void ao::_add_state(vector<float> new_event){
...
void ao::m_add_state(int argc, t_atom *argv){
...
int ao::_find_better(int i, vector<float> event){
...
void ao::m_query(int argc, t_atom *argv){
...
vector<int> ao::gather_options(int n){
...
void ao::m_train_thresh(float low_r, float high_r, float step){
...
void ao::m_calculate_ir(){
    ir = _calculate_ir();
}

void ao::m_get_ir(int state){
...
vector<float> ao::_cumsum(vector<int> c0){
